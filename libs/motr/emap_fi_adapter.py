...
from commons.constants import POD_NAME_PREFIX, PARSE_SIZE, CONTAINER_PATH
...
class MotrCorruptionAdapter(InjectCorruption):
    ...
    def build_emap_command(self, fid):
        selected_shard = self.get_metadata_device(self.motr_obj.master_node_list[0])
